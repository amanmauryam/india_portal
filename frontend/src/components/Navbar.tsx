      ...
      <header className="sticky top-0 z-40 w-full border-b border-slate-200/80 bg-white/80 backdrop-blur-md dark:border-slate-800/80 dark:bg-slate-950/80">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <Link href="/" className="flex items-center gap-2.5 transition-opacity hover:opacity-90">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-tr from-amber-500 via-white to-emerald-600 p-0.5 shadow-sm ring-1 ring-slate-200 dark:ring-slate-800">
              <div className="flex h-full w-full items-center justify-center rounded-[10px] bg-slate-900 text-white font-bold text-lg">
                🇮🇳
              </div>
            </div>
            <div>
              <span className="font-extrabold text-base tracking-tight text-slate-900 sm:text-lg dark:text-white">
                Bharat<span className="text-blue-600 dark:text-blue-500">Local</span>
              </span>
              <p className="text-[10px] font-medium text-slate-500 dark:text-slate-400">Hyperlocal Utility Portal</p>
            </div>
          </Link>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center gap-2 rounded-lg border border-slate-200 bg-slate-50/50 px-3 py-1.5 text-left text-xs text-slate-500 hover:bg-slate-100 dark:border-slate-800 dark:bg-slate-900 dark:hover:bg-slate-800 sm:w-48 md:w-64"
            >
